...
# Páginas existentes para motoristas (mantidas inalteradas)
...
# Páginas existentes para motoristas continuam aqui...
# [As páginas "Importar Excel", "Editar Motorista", "Excluir Motorista", "Lista Completa" permanecem EXATAMENTE como estão]

# NOVAS PÁGINAS PARA CLIENTES
        ...
        if cliente_selecionado:
            ...
            with st.form("form_edicao_cliente"):
                ...
                with col1:
                    ...
                    nome_motorista = st.selectbox("Nome do Motorista*", 
                                                [""] + nomes_motoristas,
                                                index=([""] + nomes_motoristas).index(cliente_data.get('nome', '')) if cliente_data.get('nome', '') in [""] + nomes_motoristas else 0)
